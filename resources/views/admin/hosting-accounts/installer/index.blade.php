        ...
        <div class="col-md-6">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    @endunless
                    <form method="POST" action="{{ route('admin.hosting-accounts.installer.wordpress', $account) }}">
                        @csrf
        ...
        <div class="col-md-6">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.hosting-accounts.installer.generic-zip', $account) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-2">
                    ...
                    @forelse ($account->appInstallations as $installation)
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                @endif
                                <form method="POST" action="{{ route('admin.hosting-accounts.installer.destroy', [$account, $installation]) }}"
