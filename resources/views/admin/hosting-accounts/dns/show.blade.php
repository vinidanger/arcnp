<x-admin-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.hosting-accounts.dns.index', $account) }}" class="btn btn-sm btn-outline-secondary">{{ __('Voltar') }}</a>
        </div>
    </x-slot>
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.hosting-accounts.dns.records.store', [$account, $zone]) }}" class="row g-2 align-items-end dns-record-form">
                @csrf
                <div class="col-auto">
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <details class="d-inline-block">
                                    ...
                                    <form method="POST" action="{{ route('admin.hosting-accounts.dns.records.update', [$account, $zone, $record]) }}" class="row g-2 align-items-end mt-2 dns-record-form">
                                        @csrf
                                        @method('PUT')
                                        <div class="col-auto">
                                ...
                                <form method="POST" action="{{ route('admin.hosting-accounts.dns.records.destroy', [$account, $zone, $record]) }}"
    ...
    <div class="card border-danger">
        <div class="card-body d-flex justify-content-between align-items-center">
            ...
            <form method="POST" action="{{ route('admin.hosting-accounts.dns.destroy', [$account, $zone]) }}"
