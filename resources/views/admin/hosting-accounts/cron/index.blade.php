<x-admin-layout>
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.hosting-accounts.cron.store', $account) }}" class="row g-2 align-items-end">
                @csrf
                <div class="col-auto">
                ...
                <tbody>
                    @forelse ($account->cronJobs as $job)
                        <tr>
                            ...
                            <td class="text-end">
                                <form method="POST" action="{{ route('admin.hosting-accounts.cron.destroy', [$account, $job]) }}"
