                        ...
                        <tr>
                            <td>
                                @if ($entry['type'] === 'directory')
                                    <a href="{{ route('client.hosting-accounts.files.index', [$account, 'path' => $entryPath, 'root' => $root]) }}">📁 {{ $entry['name'] }}</a>
                                @else
                                    <a href="{{ route('client.hosting-accounts.files.edit', [$account, 'path' => $entryPath, 'root' => $root]) }}">📄 {{ $entry['name'] }}</a>
                                @endif
                            </td>
