    ...
    @if ($availableDomains !== [])
        <div class="card mb-3">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('client.hosting-accounts.dns.store', $account) }}" class="row g-2 align-items-end">
                    @csrf
                    <div class="col-auto">
                ...
                <tbody>
                    @forelse ($account->dnsZones as $zone)
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('client.hosting-accounts.dns.show', [$account, $zone]) }}" class="btn btn-sm btn-outline-secondary">{{ __('Gerenciar registros') }}</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
