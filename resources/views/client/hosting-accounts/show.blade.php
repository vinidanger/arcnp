                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6 col-md-3 col-lg-2">
                            @if ($account->ssh_enabled)
                                <a href="{{ $account->server->terminalBaseUrl() }}" target="_blank" rel="noopener" class="quick-link-card" title="{{ __('Vai pedir uma senha HTTP antes (peça ao suporte). No terminal, use o usuário: ').$account->linux_username }}">
