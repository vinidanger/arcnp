    ...
    @if ($availableDomains !== [])
        <div class="card mb-3">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('client.hosting-accounts.mail.store', $account) }}" class="row g-2 align-items-end">
                    @csrf
                    <div class="col-auto">
                ...
                <tbody>
                    @forelse ($account->mailDomains as $mailDomain)
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('client.hosting-accounts.mail.show', [$account, $mailDomain]) }}" class="btn btn-sm btn-outline-secondary">{{ __('Gerenciar') }}</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
