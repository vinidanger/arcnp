                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <details class="d-inline-block">
                                    ...
                                    <form method="POST" action="{{ route('client.hosting-accounts.mail.mailboxes.vacation.update', [$account, $mailDomain, $mailbox]) }}" class="row g-2 mt-2" style="min-width: 320px;">
                                        @csrf
                                        @method('PUT')
