    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            @if ($dnsZone)
                    ...
                    <tbody>
                        @forelse ($dnsZone->records->where('type', 'MX') as $record)
                            <tr>
                                ...
                                <td class="text-end">
                                    <form method="POST" action="{{ route('client.hosting-accounts.dns.records.destroy', [$account, $dnsZone, $record]) }}"
                ...
                <form method="POST" action="{{ route('client.hosting-accounts.dns.records.store', [$account, $dnsZone]) }}" class="row g-2 align-items-end">
                    @csrf
