...
class FileManagerController extends Controller
{
    ...
    public function edit(Request $request, HostingAccount $hosting_account, FileManagerService $files)
    {
        ...
        try {
            ...
            return redirect()->route('admin.hosting-accounts.files.index', [$hosting_account, 'path' => self::parentOf($path)])
    ...
    public function storeFile(Request $request, HostingAccount $hosting_account, FileManagerService $files)
    {
        ...
        try {
            ...
            return redirect()->route('admin.hosting-accounts.files.edit', [$hosting_account, 'path' => $path]);
        } catch (Throwable $e) {
    ...
    public function destroy(Request $request, HostingAccount $hosting_account, FileManagerService $files)
    {
        ...
        try {
            ...
            return redirect()->route('admin.hosting-accounts.files.index', [$hosting_account, 'path' => self::parentOf($data['path'])])
